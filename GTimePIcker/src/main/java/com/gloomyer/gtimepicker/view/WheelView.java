package com.gloomyer.gtimepicker.view;
...
import com.gloomyer.gtimepicker.R;
import com.gloomyer.gtimepicker.adapter.WheelAdapter;
import com.gloomyer.gtimepicker.lib.InertiaTimerTask;
import com.gloomyer.gtimepicker.lib.MessageHandler;
import com.gloomyer.gtimepicker.lib.OnItemSelectedRunnable;
import com.gloomyer.gtimepicker.lib.SmoothScrollTimerTask;
import com.gloomyer.gtimepicker.listener.LoopViewGestureListener;
import com.gloomyer.gtimepicker.listener.OnItemSelectedListener;
import com.gloomyer.gtimepicker.utils.DensityUtils;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        dp32 = DensityUtils.dp2px(getContext(), 32);
        ...
        if (attrs != null) {
            ...
            textSize = (int) a.getFloat(R.styleable.wheelview_textSize, 16);
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            ...
            System.err.println("出错了！adapter.getItemsCount() == 0，联动数据不匹配");
        }
        if (!isLoop) {// 不循环的情况
            ...
            if (preCurrentIndex < 0) {// 举个例子：如果�?�数�?5，preCurrentIndex �?
                // �?1，那么preCurrentIndex按循环来说，其实�?0的上面，也就�?4的位�?
